...
class BaseSiteController extends Controller {
    ...
    public function __construct()
    {
        ...
        // View::share('aboutLinks', AboutLink::orderBy('position', 'ASC')->take(7)->get());

        // View::share('supportLinks', SupportLink::orderBy('position', 'ASC')->take(7)->get());

        // View::share('ictLinks', IctLink::orderBy('position', 'ASC')->take(7)->get());
